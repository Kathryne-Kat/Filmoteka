  ...
  const infoMarkup = `<div class="description-modal_wrap">
        ...
        <ul class="description-modal_list">
          <li class="description-modal_item">
            ...
            <div>
              <span class="description-rating">${vote_average.toFixed(
                1
              )} </span> &nbsp;/ 
...
const onBtnWatchedClick = e => {
  ...
  if (findId) {
    arrFilmWatched.splice(
      arrFilmWatched.findIndex(film => +film === +idFilm),
      1
    );
    // console.log(arrFilmWatched);
  ...
  if (
    ...
    refs.btnWatchedEl.classList.contains('active')
  ) {
    renderWatched();
  }
};
...
const onBtnQueueClick = e => {
  ...
  if (findId) {
    arrFilmQueue.splice(
      arrFilmQueue.findIndex(film => +film === +idFilm),
      1
    );
    // console.log(arrFilmQueue);
  ...
  if (
    window.location.pathname === '/library.html' &&
    refs.btnQueueEl.classList.contains('active')
  ) {
    renderQueue();
  }
};
